...
<ArticleImage src={import.meta.env.BASE_URL + 'changelog-001/queries.png'}  alt="Slack queries" title="" source="">
</ArticleImage>
...
<ArticleImage  src={import.meta.env.BASE_URL + "changelog-001/webhooks.png"} alt="Baselime webhooks" title="" source="">
</ArticleImage>
...
<ArticleImage  src={import.meta.env.BASE_URL + "changelog-001/autocomplete.png"}  alt="Autocomplete" title="" source="">
</ArticleImage>
