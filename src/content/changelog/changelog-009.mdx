...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-009/granularity-selector.png"}  alt="Baselime console granularity selector" title="Baselime console granularity selector" source="">
</ArticleImage>
...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-009/contextual-dropdowns.png"}  alt="Baselime console dataset selector" title="Baselime console dataset selector" source="">
</ArticleImage>
