...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-006/discovered-services.png"}  alt="Discovered services" title="Discovered services" source="">
</ArticleImage>
...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-006/query-examples.png"}  alt="Query examples" title="Baselime Query Examples" source="">
</ArticleImage>
...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-006/slack-alerts.png"}  alt="Improved Slack alerts" title="Improved Slack alerts" source="">
</ArticleImage>
