...
<ArticleImage   src={import.meta.env.BASE_URL + "changelog-003/onboarding.png"}  alt="New Onboarding Flow" title="" source="">
</ArticleImage>
...
<ArticleImage   src={import.meta.env.BASE_URL + "changelog-003/apigateway.png"}  alt="API Gateway Logs connector" title="An example API Gateway log on Baselime" source="">
</ArticleImage>
...
<ArticleImage   src={import.meta.env.BASE_URL + "changelog-003/import.png"}  alt="Automatic Discovery of your CloudFormation Stacks" title="" source="">
</ArticleImage>
...
<ArticleImage   src={import.meta.env.BASE_URL + "changelog-003/interactive.png"}  alt="Interactivity, Everywhere." title="From any event, you can filter results by any value, search for any value, or group by any key or nested key" source="">
</ArticleImage>
...
<ArticleImage   src={import.meta.env.BASE_URL + "changelog-003/slack.png"}  alt="Improved alerts in Slack" title="" source="">
</ArticleImage>
