...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-016/mark-command.png"}  alt="Baselime mark command" title="Baselime mark command" source="">
</ArticleImage>
...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-016/ingestion-pipelines.png"}  alt="Architecture diagram of the Baselime ingestion pipelines" title="Architecture diagram of the Baselime ingestion pipelines" source="">
</ArticleImage>
