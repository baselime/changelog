...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-008/baselime-test-command.png"}  alt="baselime test command" title="baselime test command" source="">
</ArticleImage>
