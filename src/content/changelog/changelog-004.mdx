...
[<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-004/visual-builder.gif"}  alt="Visual Query Builder" title="Visual Query Builder" source="https://www.youtube.com/watch?v=QuLT55XqJsE" sourceCaption="Watch full video">
...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-004/cloudwatch-metrics.png"}  alt="CloudWatch Metrics connector" title="An example CloudWatch metric in Baselime" source="">
</ArticleImage>
...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-004/ci-platforms.png"}  alt="Major CI platforms" title="Major CI/CD providers supported" source="">
</ArticleImage>
...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-004/github-report.png"}  alt="Report on the health of a service posted to GitHub with the baselime report command" title="Report on the health of a service posted to GitHub with the baselime report command" source="">
</ArticleImage>
...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-004/templates.png"}  alt="Example service definition with templates and variables" title="Example service definition with templates and variables" source="">
</ArticleImage>
...
<ArticleImage client:visible   src={import.meta.env.BASE_URL + "changelog-004/interactive-cli.png"}  alt="Interactive CLI commands" title="Get familiar with all Baselime commands in interactive mode" source="">
</ArticleImage>
